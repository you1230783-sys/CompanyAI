...
`app.png` 是使用者於 2026-09-23 提供的 `icon.png` 三花貓原始圖片副本（0.8.9 起）。
...
build.rs 以 Windows SDK 的 rc.exe 嵌入 EXE 資源 ID 1，檔案總管、視窗、工作列與系統托盤共用此圖案。左上角品牌圖片也由同一 ICO 嵌入；NSIS 安裝與解除安裝圖示使用相同來源。
